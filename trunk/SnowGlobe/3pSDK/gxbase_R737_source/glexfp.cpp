 ...
 * Generated on Sat Oct 22 20:42:56 2011
...
GLAPI void APIENTRY stub_glBlendColor (GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha) {
}
...
GLAPI void APIENTRY stub_glSampleCoverage (GLclampf value, GLboolean invert) {
}
...
GLAPI void APIENTRY stub_glMultiDrawArrays (GLenum mode, const GLint *first, const GLsizei *count, GLsizei primcount) {
}
GLAPI void APIENTRY stub_glMultiDrawElements (GLenum mode, const GLsizei *count, GLenum type, const GLvoid* *indices, GLsizei primcount) {
}
...
GLAPI void APIENTRY stub_glShaderSource (GLuint shader, GLsizei count, const GLchar* *string, const GLint *length) {
}
...
GLAPI void APIENTRY stub_glTransformFeedbackVaryings (GLuint program, GLsizei count, const GLchar* *varyings, GLenum bufferMode) {
}
...
GLAPI void APIENTRY stub_glDrawArraysInstanced (GLenum mode, GLint first, GLsizei count, GLsizei primcount) {
}
GLAPI void APIENTRY stub_glDrawElementsInstanced (GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLsizei primcount) {
}
...
GLAPI void APIENTRY stub_glMinSampleShading (GLclampf value) {
}
...
GLAPI void APIENTRY stub_glSampleCoverageARB (GLclampf value, GLboolean invert) {
}
...
GLAPI void APIENTRY stub_glGetUniformIndices (GLuint program, GLsizei uniformCount, const GLchar* *uniformNames, GLuint *uniformIndices) {
}
...
GLAPI void APIENTRY stub_glDrawElementsInstancedBaseVertex (GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLsizei primcount, GLint basevertex) {
}
GLAPI void APIENTRY stub_glMultiDrawElementsBaseVertex (GLenum mode, const GLsizei *count, GLenum type, const GLvoid* *indices, GLsizei primcount, const GLint *basevertex) {
}
...
GLAPI void APIENTRY stub_glMinSampleShadingARB (GLclampf value) {
}
...
GLAPI void APIENTRY stub_glDepthRangef (GLclampf n, GLclampf f) {
}
GLAPI void APIENTRY stub_glClearDepthf (GLclampf d) {
}
...
GLAPI GLuint APIENTRY stub_glCreateShaderProgramv (GLenum type, GLsizei count, const GLchar* *strings) {
	return (GLuint)0;
}
...
GLAPI void APIENTRY stub_glDepthRangeArrayv (GLuint first, GLsizei count, const GLclampd *v) {
}
GLAPI void APIENTRY stub_glDepthRangeIndexed (GLuint index, GLclampd n, GLclampd f) {
}
...
GLAPI void APIENTRY stub_glDrawArraysInstancedBaseInstance (GLenum mode, GLint first, GLsizei count, GLsizei primcount, GLuint baseinstance) {
}
GLAPI void APIENTRY stub_glDrawElementsInstancedBaseInstance (GLenum mode, GLsizei count, GLenum type, const void *indices, GLsizei primcount, GLuint baseinstance) {
}
GLAPI void APIENTRY stub_glDrawElementsInstancedBaseVertexBaseInstance (GLenum mode, GLsizei count, GLenum type, const void *indices, GLsizei primcount, GLint basevertex, GLuint baseinstance) {
}
GLAPI void APIENTRY stub_glDrawTransformFeedbackInstanced (GLenum mode, GLuint id, GLsizei primcount) {
}
GLAPI void APIENTRY stub_glDrawTransformFeedbackStreamInstanced (GLenum mode, GLuint id, GLuint stream, GLsizei primcount) {
}
...
GLAPI void APIENTRY stub_glBlendColorEXT (GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha) {
}
...
GLAPI void APIENTRY stub_glVertexWeightPointerEXT (GLsizei size, GLenum type, GLsizei stride, const GLvoid *pointer) {
}
...
GLAPI void APIENTRY stub_glPixelDataRangeNV (GLenum target, GLsizei length, GLvoid *pointer) {
}
...
GLAPI GLvdpauSurfaceNV APIENTRY stub_glVDPAURegisterVideoSurfaceNV (GLvoid *vdpSurface, GLenum target, GLsizei numTextureNames, const GLuint *textureNames) {
